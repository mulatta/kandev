...
- update_task_kandev: Update a task. Required params: task_id. Optional: title, description, state, deferred_launch_prompt (rewrite the prompt a not-yet-started task created with blocked_by will launch with; rejected once the task has started).
